...
The class under contract here is `Detain\MyAdminVpsDirectadmin\Plugin`.
...
- This package declares `$module = 'vps'`. Changing it detaches the plugin from the events core dispatches to it, so the generated pin asserts it.
